...
export default function PaymentHistory({ brandId }: PaymentHistoryProps) {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'FAILED':
        return <XCircle className="w-5 h-5 text-error-500 dark:text-error-400" />;
      case 'PENDING':
        return <Clock className="w-5 h-5 text-warning-500 dark:text-warning-400" />;
      default:
        return <Clock className="w-5 h-5 text-neutral-400 dark:text-neutral-600" />;
    }
  };
  ...
  const getStatusBadge = (status: string) => {
    const styles: Record<string, string> = {
      ...
      REFUNDED: 'bg-accent-100 dark:bg-accent-900/30 text-accent-700 dark:text-accent-400',
    };
    return styles[status] || 'bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300';
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-primary-500 to-primary-600 dark:from-primary-600 dark:to-primary-700 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-primary-100 dark:text-primary-200 text-sm">Total Paid</p>
        ...
        <div className="bg-gradient-to-br from-success-500 to-success-600 dark:from-success-600 dark:to-success-700 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-success-100 dark:text-success-200 text-sm">Transactions</p>
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-100 dark:border-neutral-700 overflow-hidden">
        <div className="px-6 py-4 border-b border-neutral-100 dark:border-neutral-700 flex items-center justify-between">
          <h3 className="font-semibold text-neutral-900 dark:text-neutral-100">Payment History</h3>
          <button
        ...
        {payments.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-neutral-500 dark:text-neutral-400">No payment history yet</p>
          </div>
        ) : (
          <>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-neutral-100 dark:divide-neutral-700">
                  {payments.map((payment) => (
                    <tr key={payment.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-neutral-600 dark:text-neutral-400">
                          ...
                          {payment.metadata?.type === 'upi' && (
                            <span className="ml-1 text-xs text-neutral-400 dark:text-neutral-500">(UPI)</span>
                          )}
                        </div>
                      </td>
              ...
              <div className="px-6 py-4 border-t border-neutral-100 dark:border-neutral-700 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="p-2 border border-neutral-200 dark:border-neutral-700 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
